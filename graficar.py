...
#         cols=3,
#         subplot_titles=[
#             f"<b>Disponibilidad Proceso {proceso_sel}</b>", #(2023-2026)
...
#         # convertir NaN o "Nan" a vacío
#         df["mes"] = df["mes"].replace(["Nan", "None"], "")
#         df["mes"] = df["mes"].fillna("")

#         # definir orden de meses (incluyendo vacío)
